  ...
  >
    ...
    <div class="popover violeta-var">
      <v-list class="mode-menu">
        <v-subheader>{{ $t('layouts.header_theme') }}</v-subheader>
        <v-list-item>
          <v-list-item-content>
            <div class="flex-menu">
              <label>{{ $t('layouts.header_light') }}</label>
              <v-switch
                v-model="dark"
                label
                class="switch-toggle"
                ...
                @change="setDark()"
              />
              <label>{{ $t('layouts.header_dark') }}</label>
            </div>
          </v-list-item-content>
        </v-list-item>
      </v-list>
      ...
      <v-list class="lang-menu">
        <v-subheader>{{ $t('layouts.header_language') }}</v-subheader>
        <v-list-item
